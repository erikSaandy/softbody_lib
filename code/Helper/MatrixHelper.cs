...
public static class MatrixHelper
{
	...
	public static Matrix4x4 CreateTRS(Vector3 translation, Rotation rotation, Vector3 scale)
	{
		Angles angle = rotation.Angles();
		return Matrix4x4.CreateTranslation( translation ) * Matrix4x4.CreateFromYawPitchRoll( angle.yaw, angle.pitch, angle.roll ) * Matrix4x4.CreateScale( scale );
	}
