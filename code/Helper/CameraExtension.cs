...
public static class CameraExtension
{
	...
	public static Matrix4x4 ProjectionMatrix(this CameraComponent camera)
	{
		return Matrix4x4.CreatePerspectiveFieldOfView( camera.FieldOfView * Math2d.Deg2Rad, Screen.Aspect, camera.ZNear, camera.ZFar );
	}
